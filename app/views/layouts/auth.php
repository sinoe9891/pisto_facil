...
<head>
  ...
  <style>
    ...
    .auth-logo .icon { background:#2563eb; width:64px; height:64px; border-radius:16px;
    ...
    .auth-logo p  { color:#64748b; font-size:.875rem; margin:0; }
    .form-label   { font-weight:600; font-size:.875rem; color:#374151; }
    .form-control { border-radius:10px; border:1.5px solid #e2e8f0; padding:.6rem .9rem; }
    .form-control:focus { border-color:#2563eb; box-shadow:0 0 0 3px rgba(37,99,235,.15); }
    .btn-login { background:#2563eb; border:none; border-radius:10px; padding:.7rem;
      font-weight:600; width:100%; transition:background .2s; }
    .btn-login:hover { background:#1d4ed8; }
    .input-group .btn { border-radius:0 10px 10px 0; border:1.5px solid #e2e8f0; border-left:0; }
  </style>
</head>
<body>
<div class="auth-card">
