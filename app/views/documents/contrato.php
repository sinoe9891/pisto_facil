  ...
  <style>
    * {
    ...
    @media print {
      ...
      /* IMPORTANTE: no dupliques márgenes */
      @page {
      ...
      .page {
        ...
        /* ✅ aquí defines el “margen real” dentro de la hoja */
        padding:
          <?= setting('contract_margin_top', '1.5cm') ?> <?= setting('contract_margin_right', '2cm') ?> 2.2cm
          /* reserva para el footer */
          <?= setting('contract_margin_right', '2cm') ?>;
      ...
      /* ✅ Footer por página sin encimarse */
      .page::after {
        position: absolute;
        bottom: 0.8cm;
        left: <?= setting('contract_margin_right', '2cm') ?>;
        right: <?= setting('contract_margin_right', '2cm') ?>;
        font-size: 9pt;
        color: #666;
  ...
  (en adelante <strong>"EL DEUDOR"</strong>).
    ...
    <table class="datos">
      ...
      <tr>
        ...
        <td><?= e($loanTypeLabel) ?></td>
      </tr>
      <tr>
        <td>Plazo</td>
        <td><?= $term ?> cuota<?= $term > 1 ? 's' : '' ?> <?= $freq ?></td>
      </tr>
      <tr>
      ...
      <tr>
        <td>Primer Pago Vencimiento</td>
        <td><?= $firstPay ?></td>
      </tr>
      <tr>
        <td>Último Pago Vencimiento</td>
        <td><?= $maturity ?></td>
      </tr>
      <tr>
