...
<div class="d-flex align-items-center justify-content-between mb-3">
  ...
  <div class="btn-group btn-group-sm">
    ...
    <a href="<?= url('/loans/' . $loan['id'] . '/pagare') ?>"
      class="btn btn-outline-dark btn-sm" target="_blank">
      <i class="bi bi-file-earmark-text me-1"></i>Pagaré
    </a>

    <a href="<?= url('/loans/' . $loan['id'] . '/contrato') ?>"
      class="btn btn-outline-dark btn-sm" target="_blank">
      <i class="bi bi-file-earmark-ruled me-1"></i>Contrato
    </a>
    <?php if ($isAdmin): ?>
    ...
    <div class="card shadow-sm border-0">
      <div class="card-body">
        ...
        <?php $rows = [
          ...
          ['Frecuencia',     match ($loan['payment_frequency'] ?? 'monthly') {
            'weekly' => 'Semanal',
            'biweekly' => 'Quincenal',
            'monthly' => 'Mensual',
            'bimonthly' => 'Bimensual',
                ...
                <tbody>
                  ...
                  <?php else: ?>
                    ...
                    <?php if (empty($installments)): ?>
                      <tr>
                        <td colspan="8" class="text-center text-muted py-3">Sin cuotas registradas.</td>
                      </tr>
                    <?php endif; ?>
                  <?php endif; ?>
